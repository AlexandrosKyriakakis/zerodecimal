...
// divmodU256Pow10 returns the quotient and exact remainder of u / 10^k,
// reporting fits=false if the quotient exceeds 128 bits. Unlike div256by64,
...
//
// PRECONDITION (not checked): 1 <= k <= MaxPrec.
func divmodU256Pow10(u u256, k uint8) (q u128, r uint64, fits bool) {
	if u.isZeroUpper() {
		if u.d1 == 0 {
